...
/***************************************************************************
 MOVECOSTDialog
                                 A QGIS plugin
 R script for QGIS for Calculation of Slope-Dependent Accumulated Cost
 Surface, Least-Cost Paths, and Least-Cost Corridors Related to Human Movement
...
from qgis.core import (QgsApplication, QgsMapLayerType, QgsProcessingUtils,
                       QgsProject)
...
<hr>"""
    ...
    def _load_latest_plot(self):
                ...
                try:
                    ...
                    if (current_time - file_time) < 600:
                        ...
                        if not pixmap.isNull():
                            ...
                            self.label_plot.setToolTip("Plot: movecost_latest_plot.png")
                            return
        ...
        self.label_plot.setText(
            "R plots will appear here after running an algorithm\n\nClick 'Refresh Plot' after running an algorithm")
...
"""
    ...
    def get_tooltips(self, lang_code):
        ...
        return {
            'movecost': ('Calculate accumulated anisotropic slope-dependent cost'
                         ' of movement and least-cost paths from a point origin'),
